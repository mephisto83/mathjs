...
export default class ExpressionTranslation {
    translate(a, b) {
        switch (a.name()) {
     ...
     ***/
    convertSiblingsToAnExpression(siblings) {
    ...
    derivation = {
        ...
        translateSimpleFormula(a, b) {
            // Expression.SwapPart(a, b);
            return b.copy();
        },
        translateGeneralFormula5(a, b) {
            var convert = {
                from: 'A', to: 'A'
            }
            var targetselection = {
            ...
            var transformation = {
                pattern: {
                    process(transform, a_copy, b_copy) {
        ...
        translateIGeneralFormula41(a, b) {
            var transformation = {
                transformation: {
        ...
        translateIGeneralFormula45(a, b) {
        ...
        translateIGeneralFormula25(a, b) {
            var transformation = {
                transformation: {
        ...
        translateIGeneralFormula24(a, b, c, d) {
            var transformation = {
                transformation: {
    ...
    translateIntegrationByParts(a, b) {
        var transformation = {
            transformation: {
    ...
    translateIntegrationAddition(a, b) {
        switch (b.name()) {
     ...
     **/
    translateIntegralConstMultiply(a, b) {
        a = a.copy();
        b = b.copy();
        var a_marks = a.getMarks();
        var result = b.copy();
